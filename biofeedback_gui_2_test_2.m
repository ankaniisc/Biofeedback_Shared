...
% called is working
% AB: 14th Feb, 3:15 PM
% Would drawnow would also work? Let's validate that now.
% Update on 3:23 PM. Yes the drawnow works. But it has to be kept inside
% the while loop, not outside.
...
%      Collect data for 1 second    
    ...
    testgetRawData(AlphaChans); % function for aquiring one second of data
